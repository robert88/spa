...
function createFlash(opt) {
	...
	var flashInfo = {
		...
		swf: "/pc/public/js/upload/filereader.swf",
		ver: "21.0.0",
		domId: opt.id,
		width: "100%",
		height: "100%"
	...
	swfobject && swfobject.embedSWF && swfobject.embedSWF(
		flashInfo.swf, flashInfo.domId, flashInfo.width, flashInfo.height,10, flashInfo.installSwf,
		{debugMode: o.debugMode ? true : ''}, {'wmode':'transparent','allowScriptAccess':'sameDomain'}, {}, function(e){
			self.swfObject = e.ref;
